...
export default function SS675Page() {
  return (
    <main className="overflow-hidden bg-white">
          ...
          <div className="mt-10 grid items-center gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-16">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-300 sm:text-lg">
                A concealed-clip snap-lock standing seam roof panel available
                in multiple widths, materials and panel-face configurations.
              </p>
            ...
            >
              <Image
                src="/images/ss675-profile.png"
                alt="SS675 snap-lock standing seam roof panel profile"
                fill
                priority
      ...
      <section className="kam-section">
        <div className="kam-container grid gap-10 lg:grid-cols-[.75fr_1.25fr] lg:gap-16">
          <div>
            <p className="kam-eyebrow">SS675 Profile</p>

            <h2 className="kam-heading">
              Snap-lock performance with a clean finished appearance.
            </h2>
          </div>

          <div className="self-end">
            <p className="kam-copy text-base sm:text-lg">
              The SS675 is a standing seam roof panel with a 1 5/8-inch seam.
              Concealed clips secure the panel to the roof substrate while the
              adjacent panel snaps into place over the seam, leaving the
              attachment system hidden beneath the finished roof.
            </p>

            <p className="kam-copy mt-5 text-base sm:text-lg">
              KAM can produce the SS675 in several panel widths and face
              configurations to meet the requirements and appearance of the
              project.
            </p>
          </div>
        </div>
        ...
        <div className="kam-container">
          <div className="grid gap-6 lg:grid-cols-[.7fr_1.3fr] lg:items-end lg:gap-12">
            <div>
              ...
              <h2 className="kam-heading">
                SS675 panel geometry.
              </h2>
            </div>

            <p className="kam-copy max-w-2xl lg:justify-self-end">
              Reference dimensions for the SS675 snap-lock standing seam
              profile. Contact KAM with questions regarding panel sizing,
          ...
          >
            <Image
              src="/images/ss675-profile-dimensions.png"
              alt='SS675 standing seam roof panel dimensions showing 1 5/8-inch seam height and 12-inch, 14-inch, 16-inch and 18-inch coverage widths'
              fill
          ...
          <div className="grid gap-12 lg:grid-cols-3 lg:gap-6">
            ...
            <article className="border border-white/15 bg-[#111936]/45 p-7 sm:p-8">
              ...
              <p className="mt-5 leading-7 text-blue-100/70">
                SS675 panels can be produced at our Shawnee facility for
