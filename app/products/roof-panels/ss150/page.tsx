...
export default function SS150Page() {
  return (
    <main className="overflow-hidden bg-white">
          ...
          <div className="mt-10 grid items-center gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-16">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-300 sm:text-lg">
                A concealed-clip mechanically seamed standing seam roof panel
                available in multiple widths, materials and panel-face
                configurations.
              </p>
            ...
            >
              <Image
                src="/images/ss150-profile.png"
                alt="SS150 mechanically seamed standing seam roof panel profile"
                fill
                priority
      ...
      <section className="kam-section">
        <div className="kam-container grid gap-10 lg:grid-cols-[.75fr_1.25fr] lg:gap-16">
          <div>
            <p className="kam-eyebrow">SS150 Profile</p>

            <h2 className="kam-heading">
              Mechanically seamed for a secure standing seam system.
            </h2>
          </div>

          <div className="self-end">
            <p className="kam-copy text-base sm:text-lg">
              The SS150 is a mechanically seamed standing seam roof panel with
              a 1 1/2-inch seam. Adjacent panels overlap at the seam and are
            ...
            <p className="kam-copy mt-5 text-base sm:text-lg">
              ...
              KAM can produce the SS150 in multiple widths and panel-face
              configurations.
            </p>
          </div>
        </div>
        ...
        <div className="kam-container">
          <div className="grid gap-6 lg:grid-cols-[.7fr_1.3fr] lg:items-end lg:gap-12">
            <div>
              ...
              <h2 className="kam-heading">
                SS150 panel geometry.
              </h2>
            </div>

            <p className="kam-copy max-w-2xl lg:justify-self-end">
              Reference dimensions for the SS150 mechanically seamed standing
          ...
          >
            <Image
              src="/images/ss150-profile-dimensions.png"
              alt='SS150 standing seam roof panel dimensions showing 1 1/2-inch seam height and 12-inch, 16-inch, 18-inch and 20-inch coverage widths'
              fill
          ...
          <div className="grid gap-12 lg:grid-cols-3 lg:gap-6">
            ...
            <article className="border border-white/15 bg-[#111936]/45 p-7 sm:p-8">
              ...
              <p className="mt-5 leading-7 text-blue-100/70">
                SS150 panels can be produced at our Shawnee facility for
