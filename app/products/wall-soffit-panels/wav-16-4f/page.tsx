...
export default function WAV164FPage() {
  return (
        ...
        <div className="kam-container grid gap-12 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-500">
              A 16-inch architectural wave panel featuring a four-rib profile
          ...
          >
            <Image
              src="/images/wav-16-4f-profile.png"
              alt="WAV-16-4F architectural wave panel profile"
              fill
        ...
        <div className="kam-container grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              A wider wave panel with a four-rib architectural pattern.
            </h2>
          </div>

          <div>
            <p className="kam-copy">
              WAV-16-4F is an architectural wave panel with 16-inch coverage
              and a 7/8-inch profile depth. Its four-rib configuration creates
              a repeating dimensional pattern across wall and soffit surfaces.
            </p>

            <p className="kam-copy mt-5">
              The wider 16-inch coverage combines multiple profile features
              across each panel face, giving designers and installers another
              option for controlling the scale and visual rhythm of an
              architectural elevation.
            </p>

            <p className="kam-copy mt-5">
              KAM can fabricate the WAV-16-4F alongside matching trim and
      ...
      <section className="kam-section border-y border-slate-200 bg-slate-50">
        <div className="kam-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="kam-heading mt-4">
              WAV-16-4F panel geometry.
            </h2>

            <p className="kam-copy mt-5">
              Reference dimensions for KAM&apos;s 16-inch four-rib wave panel
              profile.
            </p>
          </div>
          ...
          >
            <Image
              src="/images/wav-16-4f-profile-dimensions.png"
              alt="WAV-16-4F wave panel profile dimensions"
              fill
      ...
      <section className="kam-section bg-white">
        <div className="kam-container grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              Wider coverage with a four-rib wave pattern.
            </h2>

            <p className="kam-copy mt-5">
              WAV-16-4F provides 16 inches of panel coverage with a 7/8-inch
              profile depth, combining wider coverage with a repeating
              four-rib pattern for architectural wall and soffit applications.
            </p>
          </div>
        ...
        <div className="kam-container grid gap-8 lg:grid-cols-2">
          <div className="bg-[#111936] p-8 text-white sm:p-10">
            ...
            <p className="mt-4 leading-7 text-slate-300">
              Four profile features repeat across the 16-inch coverage,
              creating a pronounced architectural pattern across the finished
              surface.
            </p>
          </div>
        ...
        <div className="kam-container grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl leading-8 text-slate-300">
              WAV-16-4F is available in KAM&apos;s standard architectural steel
