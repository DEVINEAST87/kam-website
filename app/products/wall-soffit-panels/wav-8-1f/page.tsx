...
export default function WAV81FPage() {
  return (
        ...
        <div className="kam-container grid gap-12 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-500">
              A compact 8-inch architectural wave panel featuring a single-rib
          ...
          >
            <Image
              src="/images/wav-8-1f-profile.png"
              alt="WAV-8-1F architectural wave panel profile"
              fill
        ...
        <div className="kam-container grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              A compact wave profile with architectural depth.
            </h2>
          </div>

          <div>
            <p className="kam-copy">
              WAV-8-1F is an architectural wave panel with 8-inch coverage and
              a 7/8-inch profile depth. Its single-rib configuration creates a
              repeating dimensional pattern across wall and soffit surfaces.
            </p>

            <p className="kam-copy mt-5">
              The compact 8-inch coverage makes the profile well suited for
              areas where a tighter repeating pattern is desired, including
              exterior walls, soffits, canopies and architectural accent
              areas.
            </p>

            <p className="kam-copy mt-5">
              KAM can fabricate the WAV-8-1F alongside matching trim and
      ...
      <section className="kam-section border-y border-slate-200 bg-slate-50">
        <div className="kam-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="kam-heading mt-4">
              WAV-8-1F panel geometry.
            </h2>

            <p className="kam-copy mt-5">
              Reference dimensions for KAM&apos;s 8-inch single-rib wave panel
              profile.
            </p>
          </div>
          ...
          >
            <Image
              src="/images/wav-8-1f-profile-dimensions.png"
              alt="WAV-8-1F wave panel profile dimensions"
              fill
      ...
      <section className="kam-section bg-white">
        <div className="kam-container grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              Compact coverage. Pronounced wave geometry.
            </h2>

            <p className="kam-copy mt-5">
              WAV-8-1F provides 8 inches of panel coverage with a 7/8-inch
              profile depth, creating a compact repeating wave pattern for
        ...
        <div className="kam-container grid gap-8 lg:grid-cols-2">
          <div className="bg-[#111936] p-8 text-white sm:p-10">
            ...
            <p className="mt-4 leading-7 text-slate-300">
              The 8-inch coverage creates a tighter repeating rhythm across
        ...
        <div className="kam-container grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl leading-8 text-slate-300">
              WAV-8-1F is available in KAM&apos;s standard architectural steel
      ...
      <section className="bg-[#f2c230]">
        <div className="kam-container py-14 text-center sm:py-16">
          ...
          <h2 className="mx-auto mt-3 max-w-3xl text-3xl font-black tracking-[-0.04em] text-[#111936] sm:text-4xl">
            Ready to put WAV-8-1F on your project?
          </h2>
