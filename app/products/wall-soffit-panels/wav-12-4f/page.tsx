...
export default function WAV124FPage() {
  return (
        ...
        <div className="kam-container grid gap-12 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-500">
              A 12-inch architectural wave panel featuring a multi-rib profile
              for walls, soffits and distinctive architectural accents.
            </p>
          ...
          >
            <Image
              src="/images/wav-12-4f-profile.png"
              alt="WAV-12-4F architectural wave panel profile"
              fill
        ...
        <div className="kam-container grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              More profile features across a compact 12-inch face.
            </h2>
          </div>

          <div>
            <p className="kam-copy">
              WAV-12-4F is an architectural wave panel with 12-inch coverage
              and a 7/8-inch profile depth. Its multi-rib configuration creates
              a more frequent repeating pattern across wall and soffit
              surfaces.
            </p>

            <p className="kam-copy mt-5">
              The combination of 12-inch coverage and multiple profile features
              gives WAV-12-4F a different visual rhythm than KAM&apos;s
              single-rib wave profiles, providing another option for
              architectural elevations and accent areas.
            </p>

            <p className="kam-copy mt-5">
              KAM can fabricate the WAV-12-4F alongside matching trim and
      ...
      <section className="kam-section border-y border-slate-200 bg-slate-50">
        <div className="kam-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="kam-heading mt-4">
              WAV-12-4F panel geometry.
            </h2>

            <p className="kam-copy mt-5">
              Reference dimensions for KAM&apos;s 12-inch multi-rib wave panel
              profile.
            </p>
          </div>
          ...
          >
            <Image
              src="/images/wav-12-4f-profile-dimensions.png"
              alt="WAV-12-4F wave panel profile dimensions"
              fill
      ...
      <section className="kam-section bg-white">
        <div className="kam-container grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              Twelve-inch coverage with a multi-rib pattern.
            </h2>

            <p className="kam-copy mt-5">
              WAV-12-4F provides 12 inches of panel coverage with a 7/8-inch
              profile depth, combining compact coverage with a repeating
              multi-rib wave pattern for architectural wall and soffit
              applications.
            </p>
          </div>
        ...
        <div className="kam-container grid gap-8 lg:grid-cols-2">
          <div className="bg-[#111936] p-8 text-white sm:p-10">
            ...
            <p className="mt-4 leading-7 text-slate-300">
              Multiple profile features repeat across the 12-inch coverage,
              creating a more frequent architectural pattern across the
              finished surface.
            </p>
          </div>
        ...
        <div className="kam-container grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl leading-8 text-slate-300">
              WAV-12-4F is available in KAM&apos;s standard architectural steel
          ...
          <div>
            ...
            <h2 className="mt-4 text-3xl font-black tracking-[-0.04em] sm:text-4xl">
              A repeating profile for architectural surfaces.
            </h2>
