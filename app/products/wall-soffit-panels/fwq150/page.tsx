...
export default function FWQ150Page() {
  return (
        ...
        <div className="kam-container grid gap-12 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-500">
              A deeper concealed-fastener flush panel for architectural wall,
              soffit and accent applications.
            </p>
          ...
          >
            <Image
              src="/images/fwq150-profile.png"
              alt="FWQ150 wall and soffit panel profile"
              fill
        ...
        <div className="kam-container grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              A deeper flush panel with clean architectural lines.
            </h2>
          </div>

          <div>
            <p className="kam-copy">
              FWQ150 is a concealed-fastener architectural panel designed for
              wall and soffit applications where a clean panel face and deeper
              profile are desired.
            </p>

            <p className="kam-copy mt-5">
              Available in coverage widths from 12 to 16 inches, FWQ150
              provides flexibility for coordinating panel layout, joint
              spacing and architectural proportions.
            </p>

            <p className="kam-copy mt-5">
              KAM can fabricate FWQ150 panels alongside matching trim and
              accessories to help keep the complete architectural metal package
              coordinated.
            </p>
          </div>
        </div>
      ...
      <section className="kam-section border-y border-slate-200 bg-slate-50">
        <div className="kam-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="kam-heading mt-4">
              FWQ150 panel geometry.
            </h2>

            <p className="kam-copy mt-5">
              Reference dimensions for KAM&apos;s FWQ150 wall and soffit panel
              profile.
            </p>
          </div>
          ...
          >
            <Image
              src="/images/fwq150-profile-dimensions.png"
              alt="FWQ150 wall and soffit panel profile dimensions"
              fill
      ...
      <section className="kam-section bg-white">
        <div className="kam-container grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              Adjustable from 12 to 16 inches.
            </h2>

            <p className="kam-copy mt-5">
              FWQ150 can be fabricated in coverage widths from 12 through 16
        ...
        <div className="kam-container grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl leading-8 text-slate-300">
              FWQ150 is available in KAM&apos;s standard architectural steel
