...
export default function BB7750PPage() {
  return (
        ...
        <div className="kam-container grid gap-12 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-500">
              A concealed-fastener architectural board and batten panel
              featuring a pronounced 2-inch raised batten for distinctive wall
          ...
          >
            <Image
              src="/images/bb7-750p-profile.png"
              alt="BB7-750P board and batten panel profile"
              fill
        ...
        <div className="kam-container grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              Traditional board and batten character in architectural metal.
            </h2>
          </div>

          <div>
            <p className="kam-copy">
              BB7-750P creates the strong vertical lines associated with
              traditional board and batten construction while using fabricated
              architectural metal and concealed attachment.
            </p>

            <p className="kam-copy mt-5">
              The profile features a 2-inch raised batten standing 3/4 inch
              from the panel face, creating pronounced shadow lines and
              architectural depth across the wall.
            </p>

            <p className="kam-copy mt-5">
              KAM offers the profile in 10-inch and 12 1/4-inch coverage
              options and can fabricate matching trim and project details
      ...
      <section className="kam-section border-y border-slate-200 bg-slate-50">
        <div className="kam-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="kam-heading mt-4">
              BB7-750P panel geometry.
            </h2>

            <p className="kam-copy mt-5">
              Reference dimensions for KAM&apos;s board and batten panel
              profile.
            </p>
          </div>
          ...
          >
            <Image
              src="/images/bb7-750p-profile-dimensions.png"
              alt="BB7-750P board and batten panel profile dimensions"
              fill
      ...
      <section className="kam-section bg-white">
        <div className="kam-container grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="kam-heading mt-4">
              Two coverage options for your project layout.
            </h2>

            <p className="kam-copy mt-5">
              KAM fabricates BB7-750P in 10-inch and 12 1/4-inch coverage
              widths, giving installers and designers options when
              coordinating batten spacing and overall wall proportions.
            </p>
          </div>
        ...
        <div className="kam-container grid gap-8 lg:grid-cols-2">
          <div className="bg-[#111936] p-8 text-white sm:p-10">
            ...
            <p className="mt-4 leading-7 text-slate-300">
              The pronounced 2-inch batten creates the defining vertical
          ...
          <div className="border border-slate-200 bg-white p-8 sm:p-10">
            ...
            <p className="mt-4 leading-7 text-slate-500">
              The raised profile adds depth and shadow to architectural wall
              surfaces while maintaining concealed attachment.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="kam-container grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl leading-8 text-slate-300">
              BB7-750P is available in KAM&apos;s standard architectural steel
          ...
          <div>
            ...
            <h2 className="mt-4 text-3xl font-black tracking-[-0.04em] sm:text-4xl">
              Designed to make the wall a feature.
            </h2>
